...
/***/ function(module, exports, __webpack_require__) {
	...
	var _set = __webpack_require__(359);
	...
	var $ = __webpack_require__(345),
	    ...
	    makeExample = __webpack_require__(373),
	    registerInterpret = __webpack_require__(374).registerInterpret;
	...
	var examplesSeen = new _set2.default();
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  language.semantics.addOperation("addExamples", {
	    _nonterminal: function _nonterminal(children) {
	      getWithInit(module.exports, this._node.ctorName, new _set2.default()).add(this.interval.contents);
	  ...
	  try {
	    for (var _iterator = (0, _getIterator3.default)(examples), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	function setRelevantExamples(ruleName) {
	  ...
	  if (relevantExamples) {
	    ...
	    try {
	      for (var _iterator2 = (0, _getIterator3.default)(relevantExamples), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	function getExampleString() {
	  return (0, _stringify2.default)(examples, function (k, v) {
	    if (v instanceof _set2.default) {
	      var a = [];
	      ...
	      try {
	        for (var _iterator3 = (0, _getIterator3.default)(v), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(305).Set;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.2 Set Objects
	__webpack_require__(368)('Set', function(get){
	  return function Set(){ return get(this, arguments.length > 0 ? arguments[0] : undefined); };
	}, {
	  // 23.2.3.1 Set.prototype.add(value)
	  add: function add(value){
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Set', {toJSON: __webpack_require__(370)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var language = __webpack_require__(371),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _regenerator2 = _interopRequireDefault(_regenerator);
        var _regeneratorRuntime = _regenerator2.default;
	...
	var _marked = [Exp, AddExp, AddExp_plus, AddExp_minus, MulExp, MulExp_times, MulExp_divide, ExpExp, ExpExp_power, PriExp, PriExp_paren, PriExp_pos, PriExp_neg, ident, number, number_whole, number_fract, digit, alnum, letter, stochasticChooseGen, arrayInfGen, concatInfGen, cycleGen, starGen, shuffleGen].map(_regeneratorRuntime.mark);
	
	var EXAMPLES = __webpack_require__(348),
	    $ = __webpack_require__(345),
	    makeExample = __webpack_require__(373),
	    language = __webpack_require__(371),
	    diversity_fns = __webpack_require__(405);
	...
	function Exp(es) {
	  ...
	  return _regenerator2.default.wrap(function Exp$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          ...
	          _context.prev = 4;
	          _iterator = (0, _getIterator3.default)(shuffleGen(es, seen));
	        ...
	        case 27:
	          ...
	          _context.prev = 30;
	          _iterator2 = (0, _getIterator3.default)(AddExp([]));
	...
	function AddExp(aes) {
	  ...
	  return _regenerator2.default.wrap(function AddExp$(_context2) {
	    while (1) {
	      switch (_context2.prev = _context2.next) {
	        case 0:
	          ...
	          _context2.prev = 4;
	          _iterator3 = (0, _getIterator3.default)(shuffleGen(aes, seen));
	        ...
	        case 27:
	          ...
	          _context2.prev = 30;
	          _iterator4 = (0, _getIterator3.default)(stochasticChooseGen(AddExp_plus([]), AddExp_minus([]), MulExp([])));
	...
	function AddExp_plus(aes) {
	  ...
	  return _regenerator2.default.wrap(function AddExp_plus$(_context3) {
	    while (1) {
	      switch (_context3.prev = _context3.next) {
	        case 0:
	          ...
	          _context3.prev = 4;
	          _iterator5 = (0, _getIterator3.default)(shuffleGen(aes, seen));
	        ...
	        case 27:
	          ...
	          _context3.prev = 30;
	          _iterator6 = (0, _getIterator3.default)(arrayInfGen(AddExp(EXAMPLES.AddExp), MulExp([])));
	...
	function AddExp_minus(aes) {
	  ...
	  return _regenerator2.default.wrap(function AddExp_minus$(_context4) {
	    while (1) {
	      switch (_context4.prev = _context4.next) {
	        case 0:
	          ...
	          _context4.prev = 4;
	          _iterator7 = (0, _getIterator3.default)(shuffleGen(aes, seen));
	        ...
	        case 27:
	          ...
	          _context4.prev = 30;
	          _iterator8 = (0, _getIterator3.default)(arrayInfGen(AddExp(EXAMPLES.AddExp), MulExp([])));
	        ...
	        case 32:
	          ...
	          _step8$value = (0, _slicedToArray3.default)(_step8.value, 2);
	          _ae4 = _step8$value[0];
	          _me = _step8$value[1];
	          _context4.next = 38;
	          return _ae4 + " - " + _me;
	...
	function MulExp(mes) {
	  ...
	  return _regenerator2.default.wrap(function MulExp$(_context5) {
	    while (1) {
	      switch (_context5.prev = _context5.next) {
	        case 0:
	          ...
	          _context5.prev = 4;
	          _iterator9 = (0, _getIterator3.default)(shuffleGen(mes, seen));
	        ...
	        case 27:
	          ...
	          _context5.prev = 30;
	          _iterator10 = (0, _getIterator3.default)(stochasticChooseGen(MulExp_times([]), MulExp_divide([]), ExpExp([])));
	...
	function MulExp_times(mes) {
	  ...
	  return _regenerator2.default.wrap(function MulExp_times$(_context6) {
	    while (1) {
	      switch (_context6.prev = _context6.next) {
	        case 0:
	          ...
	          _context6.prev = 4;
	          _iterator11 = (0, _getIterator3.default)(shuffleGen(mes, seen));
	        ...
	        case 27:
	          ...
	          _context6.prev = 30;
	          _iterator12 = (0, _getIterator3.default)(arrayInfGen(MulExp(EXAMPLES.MulExp), ExpExp([])));
	...
	function MulExp_divide(mes) {
	  ...
	  return _regenerator2.default.wrap(function MulExp_divide$(_context7) {
	    while (1) {
	      switch (_context7.prev = _context7.next) {
	        case 0:
	          ...
	          _context7.prev = 4;
	          _iterator13 = (0, _getIterator3.default)(shuffleGen(mes, seen));
	        ...
	        case 27:
	          ...
	          _context7.prev = 30;
	          _iterator14 = (0, _getIterator3.default)(arrayInfGen(MulExp(EXAMPLES.MulExp), ExpExp([])));
	        ...
	        case 32:
	          ...
	          _step14$value = (0, _slicedToArray3.default)(_step14.value, 2);
	...
	function ExpExp(ees) {
	  ...
	  return _regenerator2.default.wrap(function ExpExp$(_context8) {
	    while (1) {
	      switch (_context8.prev = _context8.next) {
	        case 0:
	          ...
	          _context8.prev = 4;
	          _iterator15 = (0, _getIterator3.default)(shuffleGen(ees, seen));
	        ...
	        case 27:
	          ...
	          _context8.prev = 30;
	          _iterator16 = (0, _getIterator3.default)(stochasticChooseGen(ExpExp_power([]), PriExp([])));
	...
	function ExpExp_power(ees) {
	  ...
	  return _regenerator2.default.wrap(function ExpExp_power$(_context9) {
	    while (1) {
	      switch (_context9.prev = _context9.next) {
	        case 0:
	          ...
	          _context9.prev = 4;
	          _iterator17 = (0, _getIterator3.default)(shuffleGen(ees, seen));
	        ...
	        case 27:
	          ...
	          _context9.prev = 30;
	          _iterator18 = (0, _getIterator3.default)(arrayInfGen(PriExp([]), ExpExp(EXAMPLES.ExpExp)));
	        ...
	        case 32:
	          ...
	          _step18$value = (0, _slicedToArray3.default)(_step18.value, 2);
	          pe = _step18$value[0];
	...
	function PriExp(pes) {
	  ...
	  return _regenerator2.default.wrap(function PriExp$(_context10) {
	    while (1) {
	      switch (_context10.prev = _context10.next) {
	        case 0:
	          ...
	          _context10.prev = 4;
	          _iterator19 = (0, _getIterator3.default)(shuffleGen(pes, seen));
	        ...
	        case 27:
	          ...
	          _context10.prev = 30;
	          _iterator20 = (0, _getIterator3.default)(stochasticChooseGen(PriExp_paren([]), PriExp_pos([]), PriExp_neg([]), ident([]), number([])));
	...
	function PriExp_paren(pes) {
	  ...
	  return _regenerator2.default.wrap(function PriExp_paren$(_context11) {
	    while (1) {
	      switch (_context11.prev = _context11.next) {
	        case 0:
	          ...
	          _context11.prev = 4;
	          _iterator21 = (0, _getIterator3.default)(shuffleGen(pes, seen));
	        ...
	        case 27:
	          ...
	          _context11.prev = 30;
	          _iterator22 = (0, _getIterator3.default)(Exp(EXAMPLES.Exp));
	...
	function PriExp_pos(pes) {
	  ...
	  return _regenerator2.default.wrap(function PriExp_pos$(_context12) {
	    while (1) {
	      switch (_context12.prev = _context12.next) {
	        case 0:
	          ...
	          _context12.prev = 4;
	          _iterator23 = (0, _getIterator3.default)(shuffleGen(pes, seen));
	        ...
	        case 27:
	          ...
	          _context12.prev = 30;
	          _iterator24 = (0, _getIterator3.default)(PriExp(EXAMPLES.PriExp));
	...
	function PriExp_neg(pes) {
	  ...
	  return _regenerator2.default.wrap(function PriExp_neg$(_context13) {
	    while (1) {
	      switch (_context13.prev = _context13.next) {
	        case 0:
	          ...
	          _context13.prev = 4;
	          _iterator25 = (0, _getIterator3.default)(shuffleGen(pes, seen));
	        ...
	        case 27:
	          ...
	          _context13.prev = 30;
	          _iterator26 = (0, _getIterator3.default)(PriExp(EXAMPLES.PriExp));
	...
	function ident(idents) {
	  ...
	  return _regenerator2.default.wrap(function ident$(_context14) {
	    while (1) {
	      switch (_context14.prev = _context14.next) {
	        case 0:
	          ...
	          _context14.prev = 4;
	          _iterator27 = (0, _getIterator3.default)(shuffleGen(idents, seen));
	        ...
	        case 27:
	          ...
	          _context14.prev = 30;
	          _iterator28 = (0, _getIterator3.default)(concatInfGen(cycleGen(letter, EXAMPLES.letter), starGen(alnum, EXAMPLES.alnum)));
	...
	function number(numbers) {
	  ...
	  return _regenerator2.default.wrap(function number$(_context15) {
	    while (1) {
	      switch (_context15.prev = _context15.next) {
	        case 0:
	          ...
	          _context15.prev = 4;
	          _iterator29 = (0, _getIterator3.default)(shuffleGen(numbers, seen));
	        ...
	        case 27:
	          ...
	          _context15.prev = 30;
	          _iterator30 = (0, _getIterator3.default)(stochasticChooseGen(number_whole([]), number_fract([])));
	...
	function number_whole(numbers) {
	  ...
	  return _regenerator2.default.wrap(function number_whole$(_context16) {
	    while (1) {
	      switch (_context16.prev = _context16.next) {
	        case 0:
	          ...
	          _context16.prev = 4;
	          _iterator31 = (0, _getIterator3.default)(shuffleGen(numbers, seen));
	        ...
	        case 27:
	          ...
	          _context16.prev = 30;
	          _iterator32 = (0, _getIterator3.default)(starGen(digit, EXAMPLES.digit, numDigits));
	...
	function number_fract(numbers) {
	  ...
	  return _regenerator2.default.wrap(function number_fract$(_context18) {
	    while (1) {
	      switch (_context18.prev = _context18.next) {
	        case 0:
	          ...
	          _context18.prev = 4;
	          _iterator33 = (0, _getIterator3.default)(shuffleGen(numbers, seen));
	        ...
	        case 27:
	          ...
	          _context18.prev = 30;
	          _iterator34 = (0, _getIterator3.default)(concatInfGen(starGen(digit, EXAMPLES.digit), _regenerator2.default.mark(function _callee() {
	...
	function digit(digits) {
	  ...
	  return _regenerator2.default.wrap(function digit$(_context19) {
	    while (1) {
	      switch (_context19.prev = _context19.next) {
	        case 0:
	          ...
	          _context19.prev = 4;
	          _iterator35 = (0, _getIterator3.default)(shuffleGen(digits, seen));
	...
	function alnum(alnums) {
	  ...
	  return _regenerator2.default.wrap(function alnum$(_context20) {
	    while (1) {
	      switch (_context20.prev = _context20.next) {
	        case 0:
	          ...
	          _context20.prev = 4;
	          _iterator36 = (0, _getIterator3.default)(shuffleGen(alnums, seen));
	...
	function letter(letters) {
	  ...
	  return _regenerator2.default.wrap(function letter$(_context21) {
	    while (1) {
	      switch (_context21.prev = _context21.next) {
	        case 0:
	          ...
	          _context21.prev = 4;
	          _iterator37 = (0, _getIterator3.default)(shuffleGen(letters, seen));
	...
	function stochasticChooseGen() {
	  ...
	  return _regenerator2.default.wrap(function stochasticChooseGen$(_context22) {
	    while (1) {
	...
	function arrayInfGen() {
	  ...
	  return _regenerator2.default.wrap(function arrayInfGen$(_context23) {
	    while (1) {
	...
	function concatInfGen() {
	  ...
	  return _regenerator2.default.wrap(function concatInfGen$(_context24) {
	    while (1) {
	      switch (_context24.prev = _context24.next) {
	        case 0:
	          ...
	          _context24.prev = 3;
	          _iterator38 = (0, _getIterator3.default)(arrayInfGen.apply(undefined, _args24));
	...
	function cycleGen(genfn, samples) {
	  ...
	  return _regenerator2.default.wrap(function cycleGen$(_context25) {
	    while (1) {
	      switch (_context25.prev = _context25.next) {
	        case 0:
	          ...
	          _context25.prev = 5;
	          _iterator39 = (0, _getIterator3.default)(current);
	...
	function starGen(genfn, samples) {
	  ...
	  return _regenerator2.default.wrap(function starGen$(_context26) {
	    while (1) {
	...
	function shuffleGen(items, seen) {
	  ...
	  return _regenerator2.default.wrap(function shuffleGen$(_context27) {
	    while (1) {
	      switch (_context27.prev = _context27.next) {
	        case 0:
	          if (items instanceof _set2.default) {
	            items = [].concat((0, _toConsumableArray3.default)(items));
	          }
	          ...
	          _context27.prev = 5;
	          _iterator40 = (0, _getIterator3.default)(items);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(305).isIterable = function(it){
	  var O = Object(it);
	  return O[ITERATOR] !== undefined
	    || '@@iterator' in O
	    || Iterators.hasOwnProperty(classof(O));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Promise = __webpack_require__(395)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var USE_NATIVE = function(){
	  ...
	  try {
	    ...
	    if(works && __webpack_require__(312)){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(304)
	  ...
	  , process   = global.process
	  , Promise   = global.Promise
	  , isNode    = __webpack_require__(330)(process) == 'process'
	  , head, last, notify;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!setTask || !clearTask){
	  ...
	  // Node.js 0.8-
	  if(__webpack_require__(330)(process) == 'process'){
	    defer = function(id){
	      process.nextTick(ctx(run, id, 1));
	    };
	  // Browsers with MessageChannel, includes WebWorkers
...
/***/ function(module, exports, __webpack_require__) {
	...
	function entropy(set) {
	  ...
	  var sum = (0, _keys2.default)(buckets).reduce(function (agg, key) {
	    return agg + buckets[key];
	  }, 0);
	
	  var proportions = (0, _keys2.default)(buckets).map(function (key) {
